...
\begin{tabu}{ | p{1.4cm} | p{1.2cm} | p{1.3cm} | p{2.2cm} | p{7cm} |}
    ...
    18/09/14	& 	0.1.0	&	pawh, mfrm, hstb	&	Assignment	37		&	Elementary design, use cases and generic calendar functionality.\\ \hline
    20/09/14	& 	0.2.0	&	pawh, mfrm, hstb	&	LuckyCalender		&	We have made some major changes to the overall idea of the calendar by adding the idea of LuckyAppointments to the calendar. We have begun on the object analysis of the system.\\ \hline
    ...
    22/09/14	& 	0.2.3	&	pawh, mfrm, hstb	&	Assignment	38	&	Changes to State machine and class diagram, in order to handle appointments missing LuckyParticipants.\\ \hline
    02/10/14	& 	0.2.4	&	hstb			&	Assignment	39	&	Updated the class diagram to match the SDD.\\ \hline
    03/10/14    &   0.2.5   &   mfrm            &   feedback from Assignment 38  &   Updated the class diagram to explain notifications and LuckyAppointments, added lower level boundary objects, added notify calls in sequence diagram and extended State-Machine diagram.\\ \hline
    09/10/14    &   0.2.6   &   hstb            &  Assignment 40 &Updated the document so it matches the new requirements about recurring appointments and Google Calendar, add a small section about functional requirements.\\ \hline
    09/10/14    &   0.2.7   &   mfrm            &  Assignment 40 & Updated the use cases + use case diagram according the boundary conditions in SDDs section 3.7 \\ \hline
